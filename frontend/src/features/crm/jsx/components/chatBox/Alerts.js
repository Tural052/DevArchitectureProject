...
const Alerts = ({ toggleTab, PerfectScrollbar, toggleChatBox }) => {
  return (
    <div
      className={`tab-pane fade  ${toggleTab === "alerts"
        ? "active show"
        : ""}`}
      id="alerts"
      role="tabpanel"
    >
      <div className="card mb-sm-3 mb-md-0 contacts_card">
        <div className="card-header chat-list-header text-center">
          ...
          <div>
            <h6 className="mb-1">Bildirişlər</h6>
            <p className="mb-0">Hamısını göstər</p>
          </div>
          <Link to={"#"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="active">
              <div className="d-flex bd-highlight">
                ...
                <div className="user_info">
                  ...
                  <p className="text-primary">Bugün</p>
                </div>
              </div>
            </li>
            <li className="name-first-letter">SOSİAL</li>
            <li>
              <div className="d-flex bd-highlight">
                <div className="img_cont success">
                  RU<i className="icon fa-birthday-cake" />
                </div>
                <div className="user_info">
            ...
            <li>
              <div className="d-flex bd-highlight">
                <div className="img_cont primary">
                  AU<i className="icon fa fa-user-plus" />
                </div>
                <div className="user_info">
            ...
            <li>
              <div className="d-flex bd-highlight">
                <div className="img_cont info">
                  MO<i className="icon fa fa-user-plus" />
                </div>
                <div className="user_info">

                ...
                <ul className="timeline">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Resport created successfully <span className="badge light badge-success">Success</span>
                        </h5>
                        <small className="d-block">29 July 2020 - 02:26 PM</small>
                      </div>
                      <Dropdown className="dropdown">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Reminder : Treatment Time! <span className="badge light badge-success">Success</span>
                        </h5>
                        <small className="d-block">29 July 2020 - 02:26 PM</small>
                      </div>
                      <Dropdown className="dropdown">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        ...
                        <Link to="/widget-basic" className="btn btn-outline-danger btn-xxs ml-1">
                          Delete
                        </Link>
                      </div>
                      <Dropdown className="dropdown">
                ...
                <div className="card-action mb-sm-0 my-2">
                  <Nav className="nav nav-tabs" role="tablist">
                    <Nav.Item className="nav-item">
                      <Nav.Link className="" data-toggle="tab" to="/widget-basic" role="tab" eventKey="day">
                        Day
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="">
                      <Nav.Link className="nav-link" data-toggle="tab" to="/widget-basic" role="tab" eventKey="month">
                        Month
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="">
                      <Nav.Link className="" data-toggle="tab" to="/widget-basic" role="tab" eventKey="year">
                        Year
                      </Nav.Link>
                    </Nav.Item>
                  </Nav>
        ...
        <div className="col-xl-4 col-lg-12 col-sm-12">
          <div className="card overflow-hidden">
            ...
            <ul className="list-group list-group-flush">
              ...
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0">Patient Height</span> <strong className="text-muted">1.5 M </strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0">Patient Weight</span> <strong className="text-muted">65 Kg </strong>
              </li>
            </ul>
                ...
                <ul className="timeline">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle as="div" variant="primary light" className="i-false btn btn-info light sharp">
                          <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                              <rect x="0" y="0" width={24} height={24} />
                              <circle fill="#000000" cx="5" cy="12" r="2" />
                ...
                <ul className="timeline">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle variant="primary light" as="div" className="i-false btn btn-info light sharp">
                          <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                              <rect x="0" y="0" width={24} height={24} />
                              <circle fill="#000000" cx="5" cy="12" r="2" />

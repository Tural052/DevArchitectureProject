          ...
          <div className="collapse navbar-collapse justify-content-between">
            <div className="header-left">
              <div className="dashboard_bar" style={{ textTransform: 'capitalize' }}>
                {finalName.join(' ').length === 0 ? 'İdarə paneli' : finalName.join(' ')}
              </div>
            </div>
            <ul className="navbar-nav header-right">
              <li className="nav-item">
                <div
                  className="input-group search-area ml-auto d-inline-flex"
                  style={{
                    paddingLeft: '0',
                    paddingRight: '0',
                    background: 'none'
                ...
                >
                  <input type="text" className="form-control" placeholder="Burada axtar" />
              ...
              <Dropdown as="li" className="nav-item  notification_dropdown">
                ...
                <Dropdown.Menu align="right" className="mt-2">
                  ...
                  <Link className="all-notification" to="#">
                    Heç bir bildiris yoxdur
                  </Link>
                </Dropdown.Menu>
              </Dropdown>
              <Dropdown as="li" className="nav-item notification_dropdown ">
                <Dropdown.Toggle variant="" className="nav-link bell bell-link i-false" onClick={() => onNote()}>
              ...
              <Dropdown as="li" className="nav-item header-profile">
                <Dropdown.Toggle as="a"  to="#" variant="" className="nav-link i-false c-pointer">
                  ...
                  <div className="header-info">
                    <span>
                      TWC əməkdaşı<i className="fa fa-caret-down ml-3" aria-hidden="true"></i>
                    </span>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu align="right" className="mt-2">
                  <PerfectScrollbar>
                    <Dropdown.item>
                      ...
                      <span className="ml-2">Hesab </span>
                      </Link>
                    </Dropdown.item>
                    <Dropdown.item>
                      <Link to="/email-inbox" className="dropdown-item ai-icon">
                      <span className="ml-2">Gələnlər qutusu </span>
                      </Link>
                    </Dropdown.item>

              ...
              <div className="email-left-box px-0 mb-3">
                ...
                <div className="mail-list mt-4">
                  <Link to="/email-inbox" className="list-group-item active">
                    ...
                    Gələnlər
                    <span className="badge badge-primary badge-sm float-right">0</span>
                  </Link>
                  ...
                  <Link to="/email-inbox" className="list-group-item">
                    ...
                    Vacib
                    <span className="badge badge-danger text-white badge-sm float-right">0</span>
                  </Link>
                  <Link to="/email-inbox" className="list-group-item">
              ...
              <div className="email-right-box ml-0 ml-sm-4 ml-sm-0">
                ...
                <div className="email-list mt-3">
                  ...
                  {Messages.map((message, index) => (
                    <InboxMessage key={index} id={index} message={message}></InboxMessage>
                  ))}
                </div>

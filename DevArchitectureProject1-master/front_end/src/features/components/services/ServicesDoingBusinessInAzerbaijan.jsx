            ...
            <div className={`${styles.container}  `}>
                <section className={`${styles.topic_section} ${styles.header_section_doing_business} d-flex`}>
                    ...
                    <div className={`${styles.paragraph_section} d-flex direction-column justify-center`}>
                        <p className=" ">
                            Azərbaycan 1991-ci ildə müstəqilliyini bərpa etmiş suveren bir ölkədir. Müstəqillik əldə
                            etdikdən sonra
                            Azərbaycan iqtisadiyyatı müxtəlif sənaye sahələrinə, xüsusilə neft-qaz sektoruna birbaşa
                            xarici
                            investisiyalar cəlb etmişdir. Dinamik iqtisadi inkişafı xətti ilə davam edən Azərbaycan,
                            turizm, tikinti
                            və s. kimi sənaye sahələrində birbaşa xarici investisiyalar almağa nail olmuşdur. Bankçılıq,
                            infrastruktur
                            və hüquq sistemindəki təkmilləşdirmələr ölkəyə dünyanın hər yerindən yeni bizneslərin axın
                            etməsi və daha
                            yaxşı biznes ekosisteminin yaradılmasına səbəb olmuşdur. Bu baxımdan, Doing Business in
                            Azerbaijan xarici
                            investorlar üçün bir fürsət kimi dəyərləndirilə bilər. Bunun səbəbi işğaldan azad olunmuş
                            Dağlıq Qarabağ
                            ərazisində azad iqtisadi zonaların sayının artması, tikinti və infrastrukturun inkişafı,
                            vergi və hüquq
                            sisteminin təkmilləşdirilməsidir. Şirkətimiz Azərbaycanda biznes qurmaq və xarici
                            investorlara
                ...
                <div className={`${styles.content_container}  `}>
                    <section className={`${styles.extra_services_section} d-flex direction-column align-center`}>
                        <span className={`${styles.sub_header}  `}>Doing Business in Azerbaijan</span>
                        <span className={`${styles.service_details_title}  `}>Bu xidmətlərə daxildir</span>
                  ...
                  Xarici investorların biznes fəaliyyətinin hüquqi forması
                            ...
                            <div className={`${styles.image_item_section}  `}>
                                ...
                                <span className={`${styles.image_subtitle}  `}>
                  Maliyyələşdirmə variantları ilə bağlı məsləhət
                </span>
                            </div>
                        </section>
                    </section>

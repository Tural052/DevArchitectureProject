                            ...
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <div className="auth-form">
                                        ...
                                        {errors.email && (
                                            <div
                                                className="bg-red-300 text-danger border border-red-900 p-1 my-2">{errors.email}</div>
                                        )}
                                        {successMessage && (
                                            <div
                                                className="bg-green-300 text-danger text-green-900  p-1 my-2">{successMessage}</div>
                                        )}

                ...
                <div className="row mb-5 align-items-center">
                            ...
                            <div className="card-body px-4 py-3 py-lg-2">
                                <div className="row align-items-center">
                                    <div className="col-xl-3 col-xxl-12 col-lg-12 my-2">
                                        <p className="mb-0 fs-14">Lorem Ipsum is simply dummy text of the printing
                                            and</p>
                                    </div>
                                                ...
                                                <div className="media align-items-center">
                                                    <span className="mr-3">
                                                        ...
                                                        <rect width="4" height="16" rx="2"
                                                              transform="matrix(-1 0 0 1 4 10)" fill="#fff"></rect>
                                                        </svg>
                                                    </span>
                                                ...
                                                <div className="media align-items-center">
                                                    ...
                                                    <div className="media-body ml-1">
                                                        ...
                                                        <h4 className="mb-0 font-w600 fs-22">72%
                                                            <svg className="ml-2" width="12" height="6"
                                    ...
                                    <div className="col-xl-2 col-xxl-12 mt-2">
                                        <Dropdown className="d-inline-block">
                                            <Dropdown.Toggle variant="" as="div"
                                                             className="btn-link text-white mb-0 fs-18">
                    ...
                    <div className="col-lg-3 mb-4 mb-lg-0">
                        <button onClick={this.handleShow}
                                className="btn btn-primary light  btn-lg btn-block rounded mt-3 mt-sm-0">+ Add Data
                        </button>
                    </div>
                </div>
                        ...
                        <div className="">
                            <form id="addContactModalTitle" onSubmit={this.handleSubmission}>
                                        ...
                                        <div className="add-contact-content">
                                            <div className="form-group">
                                                ...
                                                <div className="contact-occupation">
                                                    <input type="text" className="form-control" id="actionItem"
                                                           autocomplete="off"
                                                           onChange={this.handleChange} value={this.state.actionItem}
                                                           name="actionItem" required
                                                    />
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="contact-occupation">
                                                    <input type="text" className="form-control" id="cstname"
                                                           autocomplete="off"
                                                           name="cstname" onChange={this.handleChange}
                                                           value={this.state.cstname}
                                                           required
                                                    />
                                                </div>
                                            </div>
                                ...
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-danger" onClick={this.handleClose}><i

        ...
        <form onSubmit={handleSubmit}>
            <div className="validate-redux-form row">
                <div className="col-sm-6">
                    <Field name="firstName" className="input-field-redux" component={renderTextField}
                           label="First Name"/>
                </div>
                <div className="col-sm-6">
                ...
                <div className="col-sm-12 mb-4">
                    <Field name="favoriteColor" className="input-field-redux" component={renderSelectField}
                ...
                <div className="col-sm-12 mt-2 mb-2">
                    <Field name="employed" className="input-field-redux" component={renderCheckbox}
                ...
                <div className="col-sm-12 text-center">
                    <button className="btn btn-primary mr-1" type="submit" disabled={pristine || submitting}>Submit
                    </button>
                    <button className="btn btn-light ml-1" type="button" disabled={pristine || submitting}

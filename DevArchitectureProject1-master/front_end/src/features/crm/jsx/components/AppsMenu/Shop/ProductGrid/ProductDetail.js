                                    ...
                                    <div className="product-detail-content">
                                        ...
                                        <div className="new-arrival-content pr">
                                            ...
                                            <div className="comment-review star-rating">
                                                ...
                                                <Link onClick={() => setReviewToggle(true)} className="product-review"
                                                      to="/ecom-product-detail" data-toggle="modal"
                                                      data-target="#reviewModal">Write a review?</Link>
                                            </div>
                                            <div className="d-table mb-2">
                                                <p className="price float-left d-block">$325.00</p>
                                            </div>
                                            <p> Availability:{" "}<span className="item"> {" "}In stock <i
                                                className="fa fa-shopping-basket"/></span></p>
                                            ...
                                            <div className="filtaring-area my-3">
                                                <div className="size-filter">
                                                    ...
                                                    <div className="btn-group" data-toggle="buttons">
                                                        <label
                                                            className={classnames({active: activeTab === '1'}) + ' btn btn-outline-primary light btn-sm'}
                                                            onClick={() => {
                                                                toggle('1');
                                                            }}>
                                                            <input type="radio" className="position-absolute invisible"
                                                                   name="options" id="option5"/>{" "}XS
                                                        </label>
                                                        <label
                                                            className={classnames({active: activeTab === '2'}) + ' btn btn-outline-primary light btn-sm'}
                                                            onClick={() => {
                                                                toggle('2');
                                                            }}>
                                                            <input type="radio" className="position-absolute invisible"
                                                                   name="options" id="option1" defaultChecked/>SM
                                                        </label>
                                                        <label
                                                            className={classnames({active: activeTab === '3'}) + ' btn btn-outline-primary light btn-sm'}
                                                            onClick={() => {
                                                                toggle('3');
                                                            }}>
                                                            <input type="radio" className="position-absolute invisible"
                                                                   name="options" id="option2"/>{" "} MD
                                                        </label>
                                                        <label
                                                            className={classnames({active: activeTab === '4'}) + ' btn btn-outline-primary light btn-sm'}
                                                            onClick={() => {
                                                                toggle('4');
                                                            }}>
                                                            <input type="radio" className="position-absolute invisible"
                                                                   name="options" id="option3"/>{" "}LG
                                                        </label>
                                                        <label
                                                            className={classnames({active: activeTab === '5'}) + ' btn btn-outline-primary light btn-sm'}
                                                            onClick={() => {
                                                                toggle('5');
                                                            }}>
                                                            <input type="radio" className="position-absolute invisible"
                                                                   name="options" id="option4"/>{" "}XL
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="shopping-cart mt-3">
                                                <Link className="btn btn-primary btn-lg" to="/ecom-product-detail"><i
                                                    className="fa fa-shopping-basket mr-2"/>
                                                    Add to cart
                                                </Link>
                                            </div>
                                        </div>

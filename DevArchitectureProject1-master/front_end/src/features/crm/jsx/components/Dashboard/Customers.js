        ...
        <>
            <div className="page-titles">
                <ol className="breadcrumb">
                    <li className="breadcrumb-item active"><Link to={"#"}>Müştəri</Link></li>
                    <li className="breadcrumb-item"><Link to={"#"}>Müştəri siyahısı</Link></li>
                </ol>
            </div>
            <div className="row mb-5 align-items-center">
                <div className="col-lg-3 mb-4 mb-lg-0">
                    <Link to={"#"} className="btn btn-primary light  btn-lg btn-block rounded "
                          onClick={() => setAddItem(true)}> +Yeni müştəri</Link>
                </div>
                                ...
                                <div className="col-md-5 mb-3 mb-md-0">
                                    <div className="media align-items-end">
                                        ...
                                        <div className="media-body ml-1">
                                            <p className="mb-1 fs-14">Ümumi müştərilər</p>
                                            <h3 className="mb-0 font-w600 fs-20">0 nəfər</h3>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-7 text-md-right">
                                    <Link to={"#"}
                                          className="btn btn-outline-primary rounded btn-sm px-4">Aktivlər</Link>
                                    <Link to={"#"}
                                          className="btn btn-secondary rounded ml-2 btn-sm px-4">Dəyişikliklər</Link>
                                    <Link to={"#"} className="btn btn-danger rounded ml-2 btn-sm px-4">Sil</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="">
                                <form>
                                    <div className="modal-header">
                                        <h4 className="modal-title fs-20">Yeni kontakt</h4>
                                        <button type="button" className="close" data-dismiss="modal"
                                                onClick={() => setAddItem(false)}><span>&times;</span></button>
                                    </div>
                                        ...
                                        <div className="add-contact-box">
                                            <div className="add-contact-content">
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Müştədi İd</label>
                                                    <div className="contact-name">
                                                        <input type="text" className="form-control" name="Cust_Id"
                                                               required="required" placeholder="Enter a id"
                                                               onChange={handleAddFormChange}
                                                        />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Qoşulma Tarixi</label>
                                                    <div className="contact-name">
                                                        <input type="text" className="form-control" name="Date_Join"
                                                               required="required" placeholder="Enter a date"
                                                               onChange={handleAddFormChange}
                                                        />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Müştəri Adı</label>
                                                    <div className="contact-name">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Sifariş</label>
                                                    <div className="contact-name">
                                                        <input type="text" className="form-control" name="TickOrd"
                                                               required="required" placeholder="Enter a Summary"
                                                               onChange={handleAddFormChange}
                                                        />
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Lokasiya</label>
                                                    <div className="contact-name">
                                                ...
                                                <div className="form-group">
                                                    <label className="text-black font-w500">Qiymət</label>
                                                    <div className="contact-name">
                                                        <input type="text" className="form-control" name="Price"
                                                               required="required" placeholder="Enter a price"
                                                               onChange={handleAddFormChange}
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="modal-footer">
                                        <button type="button" className="btn btn-danger"
                                                onClick={() => setAddItem(false)}><i
                                            className="flaticon-delete-1"></i> İmtina et
                                        </button>
                                        <button type="submit" onClick={handleAddFormSubmit}
                                                className="btn btn-primary">Əlavə et
                                        </button>
                                    </div>
                                </form>
                            </div>

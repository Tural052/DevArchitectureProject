            ...
            <>
                <div className="page-titles">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item"><Link to={"#"}> Plugins</Link></li>
                        <li className="breadcrumb-item active"><Link to={"#"}>Light Gallery</Link></li>
                    </ol>
                </div>
                <SimpleReactLightbox>
                    <SRLWrapper>
                                    ...
                                    <div className="card-body pb-1">
                                        <div id="lightgallery" className="row">
                                            {lightGallery.map((item, index) => (
                                                <a href={item.large} data-exthumbimage="images/big/img1.jpg"
                                                   data-src={big1} className="col-lg-3 col-md-6 mb-4" key={index}>

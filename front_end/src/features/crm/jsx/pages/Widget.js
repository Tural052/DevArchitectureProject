                                ...
                                <ul className="timeline">
                                    <li>
                                        ...
                                        <Link className="timeline-panel text-muted" to="/widget-basic">
                                            ...
                                            <h6 className="mb-0">
                                                ...
                                                className="text-primary">$500</strong>.
                                            </h6>
                                        </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <Link className="timeline-panel text-muted" to="/widget-basic">
                                            ...
                                            <h6 className="mb-0">
                                                john just buy your product <strong className="text-warning">Sell
                                                $250</strong>
                                            </h6>
                                        </Link>
                                    </li>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <Dropdown className="dropdown">
                                                <Dropdown.Toggle variant="primary light" className="i-false sharp">
                                ...
                                <ul className="timeline">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">
                                                    Resport created successfully <span
                                                    className="badge badge-warning">Warning</span>
                                                </h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <Dropdown className="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">
                                                    Dr sultads Send you Photo <span
                                                    className="badge light badge-danger">Danger</span>
                                                </h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <Dropdown className="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">
                                                    Resport created successfully <span
                                                    className="badge light badge-success">Success</span>
                                                </h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <Dropdown className="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                ...
                                                <Link to="/widget-basic" className="btn btn-primary btn-xxs shadow">
                                                    Reply
                                                </Link>
                                                <Link to="/widget-basic"
                            ...
                            >
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-panel">
                                            <div
                                                className="custom-control custom-checkbox checkbox-success check-lg mr-3">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            <div
                                                className="custom-control custom-checkbox checkbox-warning check-lg mr-3">
                                                <input type="checkbox" className="custom-control-input"
                                                       id="customCheckBox2" required=""/>
                                                <label className="custom-control-label"
                                                       htmlFor="customCheckBox2"></label>
                                            </div>
                                            <div className="media-body">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            <div
                                                className="custom-control custom-checkbox checkbox-primary check-lg mr-3">
                                                <input type="checkbox" className="custom-control-input"
                                                       id="customCheckBox3" required=""/>
                                                <label className="custom-control-label"
                                                       htmlFor="customCheckBox3"></label>
                                            </div>
                                            <div className="media-body">
                ...
                <div className="col-xl-3 col-xxl-4 col-lg-6 col-sm-6">
                    <div className="widget-stat card">
                        <div className="card-body p-4">
                            ...
                            <h3>25160$</h3>
                            <div className="progress mb-2">
                                <div className="progress-bar progress-animated bg-success" style={{width: '30%'}}></div>
                            </div>
                                ...
                                <div className="card-action mb-sm-0 my-2">
                                    <Nav className="nav nav-tabs" role="tablist">
                                        <Nav.Item className="nav-item">
                                            <Nav.Link className="" data-toggle="tab" to="/widget-basic" role="tab"
                                                      eventKey="day">
                                                Day
                                            </Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item className="">
                                            <Nav.Link className="nav-link" data-toggle="tab" to="/widget-basic"
                                                      role="tab" eventKey="month">
                                                Month
                                            </Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item className="">
                    ...
                    <div className="card overflow-hidden">
                        <div className="card-body">
                            <div className="text-center">
                                ...
                                <Link className="btn btn-outline-primary btn-rounded mt-3 px-5" to="/widget-basic">
                                    Folllow
                                </Link>
                            </div>
                        </div>
                ...
                <div className="col-xl-4 col-lg-12 col-sm-12">
                    <div className="card overflow-hidden">
                        <div className="text-center p-3 overlay-box " style={{backgroundImage: `url(${bg1})`}}>
                            <div className="profile-photo">
                                <img src={profile} width="100" className="m-auto img-fluid rounded-circle d-block"
                                     alt=""/>
                            </div>
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item d-flex justify-content-between">
                                <span className="mb-0">Patient Gender</span> <strong
                                className="text-muted">Female </strong>
                            </li>
                            <li className="list-group-item d-flex justify-content-between">
                                <span className="mb-0">Years Old</span> <strong className="text-muted">Age: 24 </strong>
                            </li>
                            <li className="list-group-item d-flex justify-content-between">
                                <span className="mb-0">Patient Height</span> <strong className="text-muted">1.5
                                M </strong>
                            </li>
                            <li className="list-group-item d-flex justify-content-between">
                                <span className="mb-0">Patient Weight</span> <strong className="text-muted">65
                                Kg </strong>
                            </li>
                        </ul>
                                        ...
                                        <td>
                                            <Dropdown className="dropdown custom-dropdown mb-0">
                                                ...
                                                <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <Dropdown.Item
                                                        className="dropdown-item text-danger">Cancel</Dropdown.Item>
                                                </Dropdown.Menu>
                                            </Dropdown>
                                        </td>
                                    </tr>
                ...
                <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                    <div className="card">
                        <div className="card-body text-center ai-icon  text-primary">
                            ...
                            <Link to="/widget-basic" className="btn my-2 btn-primary btn-lg px-4">
                                ...
                                <ul className="timeline">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <Dropdown className="dropdown">
                                                <Dropdown.Toggle as="div" variant="primary light"
                                ...
                                <ul className="timeline">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <Dropdown className="dropdown">
                                                <Dropdown.Toggle variant="primary light" as="div"
                                                                 className="i-false btn btn-info light sharp">
                                                    <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                            <rect x="0" y="0" width={24} height={24}/>

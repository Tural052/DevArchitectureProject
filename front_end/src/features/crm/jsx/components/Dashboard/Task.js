...
const PostPage = () => {
    ...
    // Redaktə etfunction editable page loop
    const [editContactId, setEditContactId] = useState(null);

    // Redaktə etfunction button click to edit
                        ...
                        <div className="">
                            <form>
                                <div className="modal-header">
                                    <h4 className="modal-title fs-20">Kontakt əlavə et</h4>
                                    <button
                                        type="button"
                                        className="close"
                                ...
                                <div className="modal-footer">
                                    ...
                                    >
                                        {" "}
                                        <i className="flaticon-delete-1"></i> rədd etmək
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            <div className="card project-boxed">
              ...
              <div className="card-body p-0 pb-3">
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item">
                    <span className="mb-0 title">Lokasiya</span> :

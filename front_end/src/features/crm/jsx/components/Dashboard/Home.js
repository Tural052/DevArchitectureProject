...
const SalesChart = loadable(() => pMinDelay(import('./../Karciz/Dashboard/SalesChart'), 1000));
const IncreaseChart = loadable(() => pMinDelay(import('./../Karciz/Dashboard/IncreaseChart'), 1000));
const IncomeChart = loadable(() => pMinDelay(import('./../Karciz/Dashboard/IncomeChart'), 1000));
const Doughnutchart = loadable(() => pMinDelay(import('./../Karciz/Dashboard/Doughnutchart'), 1000));
const SellingApexChart = loadable(() => pMinDelay(import('./../Karciz/EventPage/SellingApexChart'), 1000));
                                    ...
                                    <div className="card-body">
                                        <div className="d-sm-flex d-block pb-sm-3 align-items-end">
                                            <div className="mr-auto pr-3 mb-2 mb-sm-0">
                                                <span className="text-white fs-20 font-w200 d-block mb-sm-3 mb-2">Bugünə olan sifarişlər</span>
                                                <h2 className="fs-40 text-white mb-0">
                                                    0<span className="fs-18 ml-2"></span>
                                                </h2>
                                            </div>
                                            <div className="d-flex flex-wrap">
                                                ...
                                                <div className="ml-3">
                                                    <p className="text-warning fs-20 mb-0">+0%</p>
                                                    <span className="fs-12">Ötən gündən</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <p className="fs-12">CRM tərəfindən veriləcək rəy</p>
                                ...
                                <div className="row">
                                        ...
                                        <div className="card overflow-hidden">
                                            <div className="card-header align-items-start pb-0 border-0">
                                                <div>
                                                    ...
                                                    <span className="fs-12">Satışlar</span>
                                                </div>
                                                <Dropdown className="">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="card overflow-hidden">
                                            <div className="card-header align-items-start pb-0 border-0">
                                                <div>
                                                    <h4 className="fs-16 mb-0">Artım 0%</h4>
                                                    <span className="fs-12">Müqayisə</span>
                                                </div>
                                                <Dropdown className="">
                                                    <Dropdown.Toggle variant="" as="div" className="fs-12">
                                                        Gündəlik
                            ...
                            <div className="col-xl-3 col-xxl-4 col-md-6">
                                <div className="card">
                                    <div className="card-header border-0 pb-0">
                                        <h4 className="fs-20">Ən çox satılan</h4>
                                        <Dropdown>
                                            <Dropdown.Toggle variant="" as="div" className="fs-12">
                                                Bu həftə
                                            </Dropdown.Toggle>
                                    ...
                                    <div className="card-body">
                                        ...
                                        >
                                            <span className="text-white fs-14">çərşənbə axşamı</span>
                      ...
                      <span className="fs-14">{data.timeblog}</span>
                            ...
                            <div className="col-xl-9 col-xxl-8">
                                <div className="card event-bx">
                                    <div className="card-header border-0 pb-0">
                                        <h4 className="fs-20">Son hadisələrin icmalı</h4>
                                        <DropdownBlog/>
                                    </div>
